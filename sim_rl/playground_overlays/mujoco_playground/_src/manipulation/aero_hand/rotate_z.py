...
class CubeRotateZAxis(aero_hand_base.AeroHandEnv):
  ...
  def __init__(
    ...
    super().__init__(
        xml_path=self._XML_PATH.as_posix(),
        config=config,
...
class CubeRotateZAxis38mm(CubeRotateZAxis):
  """Same as CubeRotateZAxis but with a 38mm cube (vs default 50mm)."""

  _XML_PATH = consts.CUBE_38MM_XML


class CubeRotateZAxis25mm(CubeRotateZAxis):
  """Same as CubeRotateZAxis but with a 25mm cube (vs default 50mm)."""
